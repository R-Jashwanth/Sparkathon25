...
const AIAssistant = () => {
  ...
  const speechSupported = true; // Replace with actual speech support check if needed
  ...
  const handleSendMessage = async (message?: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { text: "Sorry, I'm having trouble connecting to the AI. Please try again.", type: "bot" },
      ]);
    } finally {
      setIsTyping(false);
    }
